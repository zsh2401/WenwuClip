...
train_loader = DataLoader(train_dataset,num_workers=args.workers, shuffle=True, batch_size=args.batch_size, pin_memory=True)

val_dataset = WenwuDataset(0.8, 0.8 + (0.1 * args.data_scale))
val_loader = DataLoader(val_dataset, num_workers=args.workers, shuffle=True, batch_size=args.batch_size, pin_memory=True)
